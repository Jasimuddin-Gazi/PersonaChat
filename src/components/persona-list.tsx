          ...
          >
            <CardHeader className="flex flex-row items-start gap-4 space-y-0 pb-2">
              <Avatar className="h-10 w-10 border">
                {/* Basic placeholder using first letter */}
                <AvatarFallback><Bot size={20} /></AvatarFallback>
              </Avatar>
              <div className="grid gap-1 flex-1">
                <CardTitle>{persona.name}</CardTitle>
                <CardDescription className="line-clamp-2">{persona.greeting}</CardDescription>
              </div>
               <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action cannot be undone. This will permanently delete the persona "{persona.name}" and all associated chat history.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
